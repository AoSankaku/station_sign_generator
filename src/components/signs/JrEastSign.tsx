        ...
        <Layer>
          ...
          <Line closed points={[width - startingPoint, linePosY, width - startingPoint, linePosY + lineHeight, width - 15, linePosY + 12]} fill={baseColor} />
          {
            ...
            <>
              ...
              <Text text={autoSpace(rightStationName)} width={width} x={-30} y={74} fontSize={15} fontStyle='500' fontFamily='NotoSansJP' fill='white' align='right' />
              <Text text={rightStationNameEnglish} width={width} x={-30} y={100} fontSize={12} fontFamily='OverusedGrotesk' fill='black' align='right' />
            </>
          }
          {
            direction == 'right' &&
            <>
              ...
              <Text text={autoSpace(leftStationName)} width={width} x={30} y={74} fontSize={15} fontStyle='500' fontFamily='NotoSansJP' fill='white' align='left' />
              <Text text={leftStationNameEnglish} width={width} x={30} y={100} fontSize={12} fontFamily='OverusedGrotesk' fill='black' align='left' />
            </>
          }
          {
