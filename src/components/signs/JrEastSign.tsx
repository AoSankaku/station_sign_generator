...
const JrEastSign: React.FC<StationProps> = (props) => {
  const { stationName, stationNameEnglish, stationNameFurigana, stationNameChinese, stationNameKorean, stationNote, leftStationName, leftStationNameEnglish, rightStationName, rightStationNameEnglish, baseColor, lineColor, ratio } = props
  ...
  return (
    <SignWrapper>
      ...
      <button onClick={handleSave}>unchiburi</button>
    </SignWrapper>
  )
}
